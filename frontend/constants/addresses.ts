...
export const ADDRESSES = {
  // Transport Layer (Across SpokePools)
  ACROSS_SPOKE_POOL_SEPOLIA: "0x5ef6C01E11889d86803e0B23e3cB3F9E9d97B662" as `0x${string}`,
  ACROSS_SPOKE_POOL_BASE_SEPOLIA: "0x82B564983aE7274c86695917BBf8C99ECb6F0F8F" as `0x${string}`,
  ACROSS_SPOKE_POOL_ARBITRUM_SEPOLIA: "0x7E63A5f1a8F0B4d0934B2f2327DAED3F6bb2ee75" as `0x${string}`,
